...
/**
 * Copied from http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/AppendixSampleDataCodeJava.html
 * for getting used to dynamodb.
 */
    ...
    private static void createTable(String tableName, long readCapacityUnits,
        ...
        try {
            ...
            if (rangeKeyName != null) {
                keySchema.add(new KeySchemaElement().withAttributeName(rangeKeyName)
